...
- Every behavioral fix gets its failing-then-passing regression test in the same change — instruction-text stale-reference cleanup is the contract's sole exception. Leave the tree green after each cluster.
